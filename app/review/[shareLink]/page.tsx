      ...
      <div className="min-h-screen bg-black flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-neutral-400 text-lg">Loading your review...</p>
          </div>
        </main>
      </div>
    )
            ...
            <div className="text-center py-20">
              <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-12 max-w-md mx-auto">
                ...
                <p className="text-neutral-400 leading-relaxed">
                  The project files haven't been uploaded yet. Please check back later or contact the project administrator.
                </p>
              </div>
            </div>
          </div>
